...
const CourseDetails = ({ data,stripePromise,clientSecret, setRoute,
  setOpen: OpenAuthModel, }: Props) => {
 ...
 useEffect(() => {
  ...
  //geting only 2 digit after decimal
  const discountPercentagePrice = discountPercentage.toFixed(0);
  // check the where use is purchased the course or not
  const isPurchased =
